...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=51, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIMER_RX, CY_INSTANCE_SHORT_NAME=TIMER_RX, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=TIMER_RX, )
...
module top ;
    ...
    Timer_v2_70_4 TIMER_RX (
        ...
        .tc(Net_61),
        .clock(Net_255));
    defparam TIMER_RX.CaptureCount = 2;
    defparam TIMER_RX.CaptureCounterEnabled = 0;
    defparam TIMER_RX.DeviceFamily = "PSoC5";
    defparam TIMER_RX.InterruptOnCapture = 0;
    defparam TIMER_RX.InterruptOnTC = 1;
    defparam TIMER_RX.Resolution = 16;
    defparam TIMER_RX.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__TP_RX_SMPL_net;
	wire [0:0] tmpFB_0__TP_RX_SMPL_net;
	wire [0:0] tmpIO_0__TP_RX_SMPL_net;
	wire [0:0] tmpINTERRUPT_0__TP_RX_SMPL_net;
	electrical [0:0] tmpSIOVREF__TP_RX_SMPL_net;

	cy_psoc3_pins_v1_10
		#(.id("92dd287a-6298-4399-8545-59223e5a10d3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TP_RX_SMPL
		 (.oe(tmpOE__TP_RX_SMPL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TP_RX_SMPL_net[0:0]}),
		  .io({tmpIO_0__TP_RX_SMPL_net[0:0]}),
		  .siovref(tmpSIOVREF__TP_RX_SMPL_net),
		  .interrupt({tmpINTERRUPT_0__TP_RX_SMPL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TP_RX_SMPL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TP_RS_EDG_net;
	wire [0:0] tmpFB_0__TP_RS_EDG_net;
	wire [0:0] tmpIO_0__TP_RS_EDG_net;
	wire [0:0] tmpINTERRUPT_0__TP_RS_EDG_net;
	electrical [0:0] tmpSIOVREF__TP_RS_EDG_net;

	cy_psoc3_pins_v1_10
		#(.id("c7205184-884b-414a-a267-34694b1e0a1d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TP_RS_EDG
		 (.oe(tmpOE__TP_RS_EDG_net),
		  .y({Net_66}),
		  .fb({tmpFB_0__TP_RS_EDG_net[0:0]}),
		  .io({tmpIO_0__TP_RS_EDG_net[0:0]}),
		  .siovref(tmpSIOVREF__TP_RS_EDG_net),
		  .interrupt({tmpINTERRUPT_0__TP_RS_EDG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TP_RS_EDG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX_BIT_SMPL_net;
	wire [0:0] tmpFB_0__TX_BIT_SMPL_net;
	wire [0:0] tmpIO_0__TX_BIT_SMPL_net;
	wire [0:0] tmpINTERRUPT_0__TX_BIT_SMPL_net;
	electrical [0:0] tmpSIOVREF__TX_BIT_SMPL_net;

	cy_psoc3_pins_v1_10
		#(.id("845886c4-987d-466c-9e09-a9bc050ba030"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TX_BIT_SMPL
		 (.oe(tmpOE__TX_BIT_SMPL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TX_BIT_SMPL_net[0:0]}),
		  .io({tmpIO_0__TX_BIT_SMPL_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_BIT_SMPL_net),
		  .interrupt({tmpINTERRUPT_0__TX_BIT_SMPL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX_BIT_SMPL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
