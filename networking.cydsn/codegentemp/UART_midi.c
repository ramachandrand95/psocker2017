                                                                ...
                                                                
    {
                    ...
                    (UART_EP[UART_midi_in_ep].bufferSize - UART_EVENT_LENGTH))
        {
            ...
            else
            {
                ...
                do
                {
                    UART_PrepareInBuffer(UART_MIDI_SYSEX, &midiMsg[msgIndex],
                                                     UART_EVENT_BYTE3, cable);

                    ic -= UART_EVENT_BYTE3;
                    msgIndex += UART_EVENT_BYTE3;
                ...
                {
                    UART_PrepareInBuffer(UART_MIDI_EOSEX, midiMsg, ic, cable);
                }
            }
        }
        else
    ...
    *******************************************************************************/
                                                                 ...
                                                                 
    {
        ...
        else if (ic == UART_MIDI_EOSEX)
        {
            ...
            {
                case 0u:
                    UART_midiInBuffer[UART_midiInPointer] =
                                                                        UART_SYSEX_ENDS_WITH1 | cable;
                    UART_midiInPointer++;
